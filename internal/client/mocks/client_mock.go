...
func (m *MockInterface) GetS3API() (s3.APIInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetS3API")
	ret0, _ := ret[0].(s3.APIInterface)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockInterface) GetSecret(arg0 s3.APIInterface, arg1 *secret.Secret) error {
	m.ctrl.T.Helper()
...
func (m *MockInterface) SetSecret(arg0 s3.APIInterface, arg1 *secret.Secret) error {
	m.ctrl.T.Helper()
