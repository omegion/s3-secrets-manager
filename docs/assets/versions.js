setTimeout(function () {
    ...
    script.src = 'https://s3-secrets-manager.readthedocs.io/_/api/v2/footer_html/?' +
        'callback=' + callbackName + '&project=s3-secrets-manager&page=&theme=mkdocs&format=jsonp&docroot=docs&source_suffix=.md&version=' + (window['READTHEDOCS_DATA'] || {version: 'latest'}).version;
...
window.addEventListener("DOMContentLoaded", function () {
    ...
    if (rtdData.version === "latest") {
        document.querySelector("div[data-md-component=announce]").innerHTML = "<div id='announce-msg'>You are" +
            " viewing the docs for an unreleased version of s3-secrets-manager, <a" +
            " href='https://s3-secrets-manager.readthedocs.io/en/stable/'>click" +
            " here to go to the latest stable version.</a></div>"
        ...
        document.querySelector("div[data-md-component=announce]").innerHTML = "<div id='announce-msg'>You are" +
            " viewing the docs for a previous version of s3-secrets-manager, <a" +
            " href='https://s3-secrets-manager.readthedocs.io/en/stable/'>click here to go to the latest stable" +
            " version.</a></div>"
        var bannerHeight = document.getElementById('announce-msg').offsetHeight + margin
        document.querySelector("header.md-header").style.top = bannerHeight + "px";
        document.querySelector('style').textContent +=
